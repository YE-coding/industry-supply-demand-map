...
for (const file of files) {
  ...
  candidates.push({
    ...
    conclusionStatus: caseItem.conclusionStatus,
    confidence: caseItem.confidence,
    evidenceAsOf: caseItem.evidenceAsOf,
    upgradeCondition: caseItem.upgradeCondition,
    downgradeCondition: caseItem.downgradeCondition,
    marketEvidenceCoverage: caseItem.marketEvidenceCoverage,
